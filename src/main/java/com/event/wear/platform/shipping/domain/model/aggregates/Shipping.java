...
public class Shipping {
    ...
    // Constructor
    public Shipping(String address, LocalDate deadline, RentId rentid,List<ShippingDetails> shippingDetails)  {
        this.address = address;
        this.deadline = deadline;
        this.trackingstatus = TrackingStatus.PACKAGING;
        this.startdate = LocalDate.now(); // Aquí se establece la fecha y hora actuales
        this.remainingDays = new RemainingDays(0).calculate(this.startdate, this.deadline); // Aquí se calcula remainingDays
        this.rentid = rentid;
    ...
    public void calculeteremainingDays(LocalDate deadline,LocalDate startdate ){ this.remainingDays = this.remainingDays.calculate(deadline,startdate);}
