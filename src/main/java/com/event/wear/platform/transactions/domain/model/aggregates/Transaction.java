...
public class Transaction extends AuditableModel {
    ...
    public Transaction(CreateTransactionCommand command){
        this.transactionId = new TransactionId(command.transactionId());
        this.rentId = new RentId(command.rentId());
    ...
    public void addRent(RentId rentId){
        this.rentId = rentId;
    }

    public void updateInformation(Long rentId, Long userId, Long lessorId, int amount,
