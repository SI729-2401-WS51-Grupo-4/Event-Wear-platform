...
* The original package name 'com.categories.event-wear-platform' is invalid and this project uses 'com.categories.event_wear_platform' instead.
...
* [ApiSwagger](http://localhost:8090/swagger-ui/index.html)